...
DEFAULT_CRITERIA = [
    {'name': 'Точность ответа',              'group': 'Точность',      'weight': 0.30},
    {'name': 'Логичность и структура',       'group': 'Точность',      'weight': 0.20},
    {'name': 'Глубина и полнота ответа',     'group': 'Точность',      'weight': 0.20},
    ...
    {'name': 'Контекстная согласованность',  'group': 'Контекст',      'weight': 0.20},
